<?php
	...
	if(!isset($_GET["page"]) or $_GET["page"] < 1){
	  ...
	  $galleryHTML = privatedeletegalleryImages($privacy_set, $page, $limit);

	  if(isset($_POST['kustutaValitud']) and !empty($_POST['check'])){
...
<head>
	<meta charset="utf-8">
	<title>Kasutaja fotoalbum - kustutamine</title>
...
<div id="modalArea" class="modalArea">
	...
	<form method="post" action="">
		<br><button type="submit" class="btn btn-danger" name="kustutaValitud">Kustuta valitud</button>
    <div>
		<br>
